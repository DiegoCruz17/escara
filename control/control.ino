...
const int ValminA = 570, ValmaxA = 658, AngMinA = 0, AngMaxA = 90;
const int ValminX = 792, ValmaxX = 880, AngMinX = 0, AngMaxX = 90;
const int ValminY = 508, ValmaxY = 600, AngMinY = 0, AngMaxY = 90;

// Variables para el sensor de distancia VL53L0X
float filteredDistance = 0, alpha = 0.1;
...
PID myPIDX(&InputX, &OutputX, &SetpointMotorX, 20, 0, 0, DIRECT);
PID myPIDY(&InputY, &OutputY, &SetpointMotorY, 12, 1.3, 0, DIRECT);
PID myPIDZ(&InputZ, &OutputZ, &SetpointMotorZ, 12, 0, 0, DIRECT);
PID myPIDA(&InputA, &OutputA, &SetpointMotorA, 10, 1.2, 0, DIRECT);
...
void loop() {
  ...
  Serial.print("Motor Z:"); Serial.print(InputZ); Serial.print(";");
  Serial.print("Motor A:"); Serial.print(InputA); Serial.print(";");
  Serial.print("Motor Y:"); Serial.print(InputY); Serial.print(";");
  Serial.print("Motor X:"); Serial.print(InputX);Serial.print(";");
  Serial.print("Servo:"); Serial.print(posServo);*/
    cont = 0;
  } 
}
...
void hacer(){
  ...
  FZ = (abs(SetpointMotorZ - InputZ) < 1) ? 0 : OutputZ;
  FA = (abs(SetpointMotorA - InputA) < 1) ? 0 : OutputA;
  FX = (abs(SetpointMotorX - InputX) < 1) ? 0 : OutputX;
